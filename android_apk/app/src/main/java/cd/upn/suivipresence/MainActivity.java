...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadApp() {
        String loginUrl = serverUrl + "/Suivi_Presence_UPN/Suivi_Presence_UPN_1/Suivi_Presence_UPN_2/index.php?controller=auth&action=login";
